...
- Solution URL: [Github repo](https://github.com/alencardotpy/three-column-preview-card-component)
- Live Site URL: [Vercel](https://three-column-preview-card-component-one.vercel.app/)
